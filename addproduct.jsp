...
.notification .badge {
  ...
  <span class="badge">3</span>
    ...
    <body>
        ...
        <form method="post" action="addprodconn.jsp">
            <center>
            <table border="1" width="30%" cellpadding="5">
                ...
                <tbody>
                   <tr>
                        <td> Product Id</td>
                        <td><input type="text" name="pid" value="" required="required" /></td>
...
<option>HP Laptops</option>
<option>Skullcandy earphones</option>
                            </select></td>
                    </tr>
                     <tr>
                        <td>Description</td>
                    ...
                    <tr>
                        <td>Price</td>
                        <td><input type="number" name="pprice" value=""required="required" /></td><br>
                    </tr>
